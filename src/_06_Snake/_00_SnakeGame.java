...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Just click the arrow keys";
	...
	private void setFoodLocation() {
		...
		Location loc = new Location(rand.nextInt(15), rand.nextInt(12));
		...
		if(snake.isLocationOnSnake(loc)) {
			loc = new Location(rand.nextInt(15), rand.nextInt(12));
		}
		foodLocation = loc;
	}
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "You died lul");
